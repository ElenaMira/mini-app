package cn.iocoder.boot.module.member.controller.app.user.vo;
...
public class AppMemberUserInfoRespVO {
    ...
    @Schema(description = "用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "zss")
    ...
    public static class Level {
        ...
        @Schema(description = "等级名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "VIP1")
        private String name;
