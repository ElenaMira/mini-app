package cn.iocoder.boot.module.product.controller.app.category;

import cn.hutool.core.collection.CollUtil;
import cn.iocoder.boot.common.Object.BeanUtils;
import cn.iocoder.boot.common.pojo.CommonResult;
import cn.iocoder.boot.module.product.controller.app.category.vo.AppCategoryRespVO;
...
public class AppCategoryController {
    ...
    public CommonResult<List<AppCategoryRespVO>> getProductCategoryList() {
        List<ProductCategoryDO> list = productCategoryService.getEnableCategoryList();
