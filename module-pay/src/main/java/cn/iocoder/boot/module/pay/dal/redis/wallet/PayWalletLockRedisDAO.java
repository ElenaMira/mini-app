package cn.iocoder.boot.module.pay.dal.redis.wallet;
...
import static cn.iocoder.boot.module.pay.dal.redis.RedisKeyConstants.PAY_WALLET_LOCK;
...
public class PayWalletLockRedisDAO {
    ...
    public <V> V lock(Long id, Long timeoutMillis, Callable<V> callable) throws Exception {
        ...
        RLock lock = redissonClient.getLock(formatKey);
        try {
