package cn.iocoder.boot.module.pay.controller.app.channel;
...
public class AppPayChannelController {
    ...
    public CommonResult<Set<String>> getEnableChannelCodeList(@NotNull @RequestParam("appId") Long appId) {
