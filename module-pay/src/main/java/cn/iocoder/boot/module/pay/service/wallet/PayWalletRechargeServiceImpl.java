...
public class PayWalletRechargeServiceImpl implements PayWalletRechargeService {
    ...
    public PayWalletRechargeDO createWalletRecharge(Long loginUserId, Integer loginUserType, String clientIP, AppPayWalletRechargeCreateReqVO reqVO) {
        ...
        PayWalletRechargeDO walletRecharge = PayWalletRechargeConvert.INSTANCE.convert(wallet.getId(), payPrice, bonusPrice, reqVO.getPackageId());
        ...
        Long payOrderId =payOrderService.createOrder(PayOrderCreateReqDTO.builder()
                        ...
                        .merchantOrderId(walletRecharge.getId().toString()).subject(WALLET_RECHARGE_ORDER_SUBJECT)
                        .body("")
        ...
        // 2.2 更新钱包充值记录中支付订单
        walletRechargeMapper.updateById(new PayWalletRechargeDO().setId(walletRecharge.getId()).setPayOrderId(payOrderId));
